    ...
    ICropper.prototype = {
        ...
        ,_init: function() {
            ...
            if (typeof Polymer != 'undefined') {
                util.connect(this.cropNode, 'touchdown', this, '_onMouseDown');
                util.connect(document, 'touchup', this, '_onMouseUp');
                util.connect(document, 'touchmove', this, '_onMouseMove');
            } else {
        ...
        ,_onMouseDown: function(e) {
            ...
            if (['move', 't', 'l', 'b', 'r', 'lt', 'rt', 'rb', 'lb'].indexOf(this.dragging) >= 0) {
                this.startedPos = {
                    x: e.detail.x
                    , y: e.detail.y
